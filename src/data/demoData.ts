...
export const doritosAnalysis: AnalysisResult = {
  ...
  confidence: 72,
  healthScore: 45,
  quickAdvice: ["Limit portion size", "Not for daily consumption", "Watch artificial colors", "Good for occasional treats"],
...
export const proteinBarAnalysis: AnalysisResult = {
  ...
  confidence: 85,
  healthScore: 72,
  quickAdvice: ["Good protein source", "May cause bloating initially", "Suitable for fitness goals"],
...
export const babyFoodAnalysis: AnalysisResult = {
  ...
  confidence: 94,
  healthScore: 92,
  quickAdvice: ["Great for babies", "Clean ingredients", "No additives", "Organic certified"],
